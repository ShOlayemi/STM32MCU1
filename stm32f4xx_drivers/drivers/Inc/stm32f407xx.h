...
/*Define the base addresses of flash and SRAM memories
*/
...
typedef struct
{
	...
	__vo uint32_t I2SPR;  		/*!< TODO,    									Address offset: 0xZ0 */
}SPI_RegDef_t;
...
#define SPI3_REG_RESET()               do{ (RCC->APB1RSTR |= (1 << 2)); (RCC->APB1RSTR &= ~(15 << 15)); }while(0)
